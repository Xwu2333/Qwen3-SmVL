#!/bin/bash
# Launch Qwen3-SmVL full-model fine-tuning (vision tower + connector + LM).
# Mirrors the env-setup / debug-print style of connector_pretraining.sh.
...
#   scripts/train/full_tuning.sh  ->  project root is ../..
# ---------------------------------------------------------------------------
